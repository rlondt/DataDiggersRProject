...
addScoreToDQFramework(COMPLEETHEID, weging=10	, waarde = 3);
#2. Zijn alle onderdelen van VWT-data vertegenwoordigd 
addScoreToDQFramework(COMPLEETHEID, weging=10	, waarde = 1);
#3. Missing values analyse 
addScoreToDQFramework(COMPLEETHEID, weging=15	, waarde = 4);
...
addScoreToDQFramework(COMPLEETHEID, weging=15	, waarde = 3);
...
addScoreToDQFramework(CONSISTENTIE, weging=5	, waarde = 2);
